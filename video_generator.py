...
def generate_video_script(prompt):
    ...
    modified_prompt = (
        f"Craft a captivating, informative, and emotional video script using this:'{prompt}' as a base. Have an expressive, positive tone. the last sentence should always 'be subscribe for more' "
...
def create_video(prompt):
    ...
    if video_clips:
        ...
        for i, caption_text in enumerate(captions_text):
            ...
            caption = TextClip(caption_text, fontsize=60, color='rgb(235, 205, 10)', align='center', bg_color='rgba(0, 0, 0, 0.45)', font="Nunito-ExtraBold.ttf")
